...
var push_algo = [
  `PUSH_STACK(STACK,TOP,MAX,ITEM) <br/><br/>
...
var arr = [];
function push() {
  var element = document.getElementById("push-item").value;
  var algo = 0;
  document.getElementById("current_algo").innerHTML = push_algo.join(" ");
  if (document.getElementById("push-item").value) {
    ...
    if (counter == 8) {
      ...
      setTimeout(function () {
        document.getElementById("current_algo").innerHTML = push_algo[1];
      }, 2000);
    } else {
      counter++;
      pushcount++;
      ...
      setTimeout(function () {
        document.getElementById("current_algo").innerHTML =
          push_algo[0] + `<p id="mid-step" >` + push_algo[2];
        +`</p>`;
      }, 2000);
      ...
      setTimeout(function () {
        ...
        document.getElementById("pushed").innerHTML = element;
...
function pop() {
  document.getElementById("current_algo").innerHTML = pop_algo.join(" ");
  if (counter >= 0) {
    ...
    setTimeout(function () {
      document.getElementById("current_algo").innerHTML =
        pop_algo[0] + `<p id="mid-step" >` + pop_algo[2];
      +`</p>`;
    }, 2000);
    setTimeout(function () {
      $("#r" + counter + 1).remove();
    ...
    document.getElementById("current_algo").innerHTML =
      pop_algo[0] + `<p id="mid-step" >` + pop_algo[1];
    +`</p>`;
    document.getElementById("top_element").innerHTML = "";
    document.getElementById("pointer").innerHTML = counter;
  }
...
function isempty() {
  ...
  document.getElementById("current_algo").innerHTML = isempty_algo.join(" ");
  if (counter < 0) {
    alert("Yes , the given stack is empty! You can PUSH elements into it ");
    setTimeout(function () {
      document.getElementById("current_algo").innerHTML =
        isempty_algo[0] + `<p id="mid-step" >` + isempty_algo[1];
      +`</p>`;
    }, 1000);
  } else {
    ...
    setTimeout(function () {
      setTimeout(function () {
        document.getElementById("current_algo").innerHTML =
          isempty_algo[0] + `<p id="mid-step" >` + isempty_algo[2];
        +`</p>`;
      }, 1000);
    }, 1000);
  }
